...
<body class="bg-gray-100 min-h-screen">
    ...
    <div class="max-w-lg mx-auto px-6 py-8">
        ...
        <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
            <form method="POST" action="{{ route('lokasi.store') }}" class="space-y-4">
                @csrf

                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Nama Ruangan *</label>
                    <input type="text" name="nama" value="{{ old('nama') }}"
                        placeholder="Dapur, Lab Komputer, Ruang Rapat, dll"
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="lantai" value="{{ old('lantai') }}"
                ...
                <div>
                    ...
                    <input type="text" name="jenis" value="{{ old('jenis') }}"
                        placeholder="Lab, Gudang, Ruang Kelas, dll"
                        class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-300">
                </div>
