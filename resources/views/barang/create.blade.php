    ...
    <div class="max-w-2xl mx-auto px-6 py-8">
        ...
        <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
            <form method="POST" action="{{ route('barang.store') }}" enctype="multipart/form-data" class="space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="nama" value="{{ old('nama') }}"
                            placeholder="Kulkas, Laptop, Meja, dll"
                ...
                {{-- No Inventaris (read only, auto-generated) --}}
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">
                        Nomor Inventaris
                        <span class="ml-1 text-xs text-indigo-500 font-normal">— otomatis digenerate setelah disimpan</span>
                    </label>
                    <div class="w-full border border-dashed border-gray-300 rounded-lg px-3 py-2 text-sm bg-gray-50 text-gray-400 italic">
                        {Gedung}-{Lantai}-{Tahun}-{Ruangan}-{Kode}-{No}/{Total}
                    </div>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="jenis_barang" value="{{ old('jenis_barang') }}"
                        placeholder="Elektronik, Furnitur, Alat Tulis, dll"
                ...
                <div>
                    ...
                    <textarea name="keterangan" rows="3"
                        ...
                        class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-300">{{ old('keterangan') }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <input type="file" name="foto" accept="image/*"
                        class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm @error('foto') border-red-400 @enderror">
